...
func (p *bar) write(_ *State, eln, width int) int {
...
var ElementBar ElementFunc = func(state *State, args ...string) string {
	...
	widthLeft := state.AdaptiveElWidth()
	...
	if total > 0 {
		// calculate count of current space
